...
<body class="text-gray-800 antialiased relative">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="max-w-2xl fade-up">
                    ...
                    <p class="text-[17px] text-gray-600 mb-10 leading-relaxed font-bold max-w-lg">
                        Bergabunglah bersama kami di ShareBite untuk menghentikan limbah makanan menjadi solusi bagi
                        mereka yang membutuhkan. Langkah kecil Anda, harapan besar mereka.
                    </p>
                    <div class="flex flex-wrap items-center gap-4">
                        <a href="/register/unit-bisnis"
                            class="bg-dark-green hover:bg-[#064225] text-white px-8 py-4 rounded-full text-sm font-black transition-all flex items-center gap-2 shadow-xl shadow-[#0a5c36]/20 hover:-translate-y-1">
                        ...
                        <a href="/login"
                            class="bg-gold hover:bg-[#855217] text-white px-8 py-4 rounded-full text-sm font-black transition-all flex items-center gap-2 shadow-xl shadow-[#9b621e]/20 hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                ...
                <div class="relative lg:ml-auto">
                    ...
                    <div
                        class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white/50 transform hover:scale-[1.02] transition-transform duration-500">
                        <!-- Badge -->
                        <div
                            class="absolute top-6 right-6 bg-gold text-white w-20 h-20 rounded-full flex flex-col items-center justify-center font-black text-center shadow-lg transform rotate-12 z-10 border-4 border-white">
                        ...
                        <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&q=80&w=800"
                            alt="Delicious Food" class="w-full max-w-[500px] object-cover aspect-square">
    ...
    <section class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 fade-up">
                <h2
                    class="text-3xl lg:text-[2.5rem] font-black text-dark-green tracking-tight leading-tight max-w-md">
                    Dampak Nyata Dari Langkah Kecil Kita.
                </h2>
                <a href="#"
                    class="text-gold font-bold flex items-center gap-2 hover:gap-3 transition-all text-sm uppercase tracking-widest">
            ...
            <div class="grid md:grid-cols-3 gap-6 fade-up">
                <!-- Stat 1 -->
                <div
                    class="bg-[#eef5f1] p-10 rounded-[2.5rem] relative overflow-hidden group hover:-translate-y-1 transition-all border border-[#1cb764]/10">
                    <div class="relative z-10">
                        <h3 class="text-5xl font-black text-dark-green mb-3">
                            {{ number_format($totalPorsiTerselamatkan, 0, ',', '.') }}+</h3>
                        <p class="text-sm font-bold text-gray-500 tracking-wide">Makanan terselamatkan</p>
                    </div>
                    <svg class="w-32 h-32 text-[#1cb764]/10 absolute -bottom-6 -right-6 group-hover:scale-110 transition-transform"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M11 2v9a3 3 0 003 3v8h2v-8a3 3 0 003-3V2h-2v7a1 1 0 01-1 1h-2a1 1 0 01-1-1V2h-2zM5 2v10a3 3 0 003 3v7h2v-7a3 3 0 003-3V2H5zm2 2h4v8a1 1 0 01-1 1H8a1 1 0 01-1-1V4z">
                        </path>
                    </svg>
                </div>
                ...
                <!-- Stat 2 -->
                <div
                    class="bg-dark-green p-10 rounded-[2.5rem] relative overflow-hidden text-white group hover:-translate-y-1 transition-all shadow-2xl shadow-[#0a5c36]/20">
                    <div class="relative z-10">
                    ...
                    <svg class="w-32 h-32 text-white/10 absolute -bottom-6 -right-6 group-hover:scale-110 transition-transform"
                        fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Stat 3 -->
                <div
                    class="bg-gold p-10 rounded-[2.5rem] relative overflow-hidden text-white group hover:-translate-y-1 transition-all shadow-2xl shadow-gold/20">
                    <div class="relative z-10">
                        ...
                        <div class="flex -space-x-3">
                            @foreach($pahlawanFotos as $foto)
                                <img class="w-12 h-12 rounded-full border-2 border-gold object-cover shadow-sm bg-white"
                                    src="{{ asset('storage/' . $foto) }}" alt="Avatar Pahlawan">
                            @endforeach
                            <!-- Filler if < 4 -->
                            @for($i = count($pahlawanFotos); $i < 3; $i++)
                                <div
                                    class="w-12 h-12 rounded-full border-2 border-gold bg-white text-gold flex items-center justify-center shadow-sm">
                            ...
                            @endfor
                            <div
                                class="w-12 h-12 rounded-full border-2 border-gold bg-white text-gold flex items-center justify-center text-xs font-black shadow-sm">
                                +</div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-32 relative bg-[#f8fbf9]">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-24 fade-up">
                <span
                    class="bg-[#1cb764]/10 text-dark-green text-[11px] font-black tracking-widest uppercase px-5 py-2 rounded-full mb-6 inline-block">Alur
                    Proses</span>
                <h2 class="text-3xl lg:text-[2.5rem] font-black text-dark-green tracking-tight">Bagaimana ShareBite
                    Bekerja?</h2>
            </div>
            ...
            <div class="relative max-w-5xl mx-auto">
                ...
                <div
                    class="hidden md:block absolute left-1/2 top-4 bottom-4 w-0 border-l-[3px] border-dashed border-[#1cb764]/30 transform -translate-x-1/2 z-0">
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-center mb-24 relative z-10 w-full group">
                    ...
                    <div class="md:w-5/12 md:pr-16 text-center md:text-right mb-8 md:mb-0 order-2 md:order-1">
                        ...
                        <p class="text-sm font-bold text-gray-500 leading-relaxed">Aktifkan notifikasi untuk mendapatkan
                            update makanan berlebih dari gerai pangan di sekitar Anda. Semua dijamin masih layak & aman
                            dikonsumsi.</p>
                    </div>
                    <!-- Center Icon -->
                    <div class="md:w-2/12 flex justify-center shrink-0 mb-6 md:mb-0 relative order-1 md:order-2">
                        <div
                            class="w-16 h-16 bg-[#e2f1e8] rounded-full flex items-center justify-center text-lg font-black text-[#0a5c36] border-[6px] border-[#f8fbf9] shadow-md relative z-10 group-hover:scale-110 group-hover:bg-[#1cb764] group-hover:text-white transition-all duration-300">
                            01
                        </div>
                    </div>
                    <!-- Image Right -->
                    <div class="md:w-5/12 md:pl-16 flex justify-center md:justify-start order-3">
                        <div
                            class="rounded-[2rem] w-full max-w-[280px] aspect-video bg-gray-200 overflow-hidden shadow-2xl border-4 border-white transform group-hover:rotate-2 transition-transform duration-500">
                            <img src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&q=80&w=600"
                                alt="Lacak Makanan" class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-center mb-24 relative z-10 w-full group">
                    ...
                    <div class="md:w-5/12 md:pr-16 flex justify-center md:justify-end order-3 md:order-1">
                        <div
                            class="rounded-[2rem] w-full max-w-[280px] aspect-video bg-gray-200 overflow-hidden shadow-2xl border-4 border-white transform group-hover:-rotate-2 transition-transform duration-500">
                            <img src="https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&q=80&w=600"
                                alt="Verifikasi" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <!-- Center Icon -->
                    <div class="md:w-2/12 flex justify-center shrink-0 mb-6 md:mb-0 relative order-1 md:order-2">
                    ...
                    <div class="md:w-5/12 md:pl-16 text-center md:text-left mb-8 md:mb-0 order-2 md:order-3">
                        ...
                        <p class="text-sm font-bold text-gray-500 leading-relaxed">Relawan kami akan memverifikasi
                            keamanan makanan dengan saksama. Segera klaim pesanan dan dapatkan pickup PIN untuk
                            mengambil makanan.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-center relative z-10 w-full group">
                    ...
                    <div class="md:w-5/12 md:pr-16 text-center md:text-right mb-8 md:mb-0 order-2 md:order-1">
                        ...
                        <p class="text-sm font-bold text-gray-500 leading-relaxed">Berikan PIN pengambilan ke mitra
                            bisnis kami, dan selamat menikmati! Anda turut mengurangi emisi karbon sekaligus menghemat
                            uang belanja.</p>
                    </div>
                    <!-- Center Icon -->
                    <div class="md:w-2/12 flex justify-center shrink-0 mb-6 md:mb-0 relative order-1 md:order-2">
                    ...
                    <div class="md:w-5/12 md:pl-16 flex justify-center md:justify-start order-3">
                        <div
                            ...
                            <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&q=80&w=600"
                                alt="Distribusi" class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-[#0a5c36] py-24 my-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-8 fade-up">
                <!-- Bisnis Pangan -->
                <div
                    class="bg-[#78a586] p-12 rounded-[2rem] text-white relative overflow-hidden group shadow-lg hover:-translate-y-1 transition-transform duration-300">
                    <svg class="absolute -right-10 -bottom-10 w-72 h-72 text-white/10 group-hover:scale-110 group-hover:-rotate-12 transition-transform duration-700"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path d="M4 6h16v2H4zm2 4h12v12H6z"></path>
                    </svg>

                    <div class="relative z-10">
                        <h3 class="text-[32px] font-black mb-5 leading-tight">Untuk Bisnis Pangan</h3>
                        <p class="text-[15px] text-white font-medium mb-10 leading-relaxed max-w-sm">Kurangi kerugian
                            finansial dan tingkatkan profil ESG perusahaan Anda dengan mendonasikan atau menjual makanan
                            sisa layak konsumsi.</p>

                        <ul class="space-y-4 mb-14 text-[15px] font-bold text-white">
                            <li class="flex items-center gap-4"><svg class="w-6 h-6 text-[#0a5c36]" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg> Reputasi Bisnis Berkelanjutan</li>
                            <li class="flex items-center gap-4"><svg class="w-6 h-6 text-[#0a5c36]" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg> Minimalisir Kerugian & Optimalisasi Stok</li>
                        </ul>

                        <a href="/register/unit-bisnis"
                            class="inline-block bg-white text-[#0a5c36] px-8 py-3.5 rounded-2xl text-[15px] font-black hover:bg-gray-50 transition-all shadow-md hover:shadow-lg">Gabung
                            Sebagai Mitra</a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[15px] text-white font-medium mb-10 leading-relaxed max-w-sm">Gunakan waktu luang
                            Anda untuk menjemput dan mengantar donasi. Jadilah bagian dari solusi nyata kelaparan.</p>

                        <ul class="space-y-4 mb-14 text-[15px] font-bold text-white">
                            <li class="flex items-center gap-4"><svg class="w-6 h-6 text-[#9b621e]" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg> Fleksibilitas Waktu</li>
                            <li class="flex items-center gap-4"><svg class="w-6 h-6 text-[#9b621e]" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg> Terbuka untuk Individu & Komunitas</li>
                        </ul>

                        <a href="/register/individu"
                            class="inline-block bg-[#9b621e] text-white px-10 py-3.5 rounded-2xl text-[15px] font-black hover:bg-[#855217] transition-all shadow-md hover:shadow-lg">Daftar
                            Relawan</a>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-white py-24 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 fade-up">
                <h2 class="text-3xl lg:text-[2.5rem] font-black text-dark-green tracking-tight">Donasi Tersedia Hari Ini
                </h2>
                <a href="/login"
                    class="text-[#1cb764] font-bold flex items-center gap-2 hover:gap-3 transition-all text-sm uppercase tracking-widest">
                    Lihat Semua Menu <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </a>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                @forelse($menus as $menu)
                    <div
                        class="bg-white border-2 border-gray-50 rounded-[2rem] p-4 shadow-sm hover:shadow-2xl transition-all group duration-300">
                        <div class="relative w-full h-56 rounded-3xl overflow-hidden mb-6 bg-gray-100">
                            <!-- Label -->
                            <div
                                class="absolute top-4 left-4 bg-[#1cb764] text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full z-10 shadow-lg">
                                Tersedia
                            </div>
                        ...
                        <div class="px-3 pb-3">
                            <h3 class="text-xl font-black text-gray-800 mb-1.5 truncate">
                                {{ $menu->masterMakanan->nama_makanan }}</h3>
                ...
                @empty
                    <div
                        class="col-span-3 text-center py-20 bg-gray-50 rounded-[3rem] border-2 border-dashed border-gray-200">
