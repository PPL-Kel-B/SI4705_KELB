...
@section('content')
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        {{-- Profile Header Card --}}
        <div
            class="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-gray-50 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
            {{-- Decorative Background Glow --}}
            <div
                class="absolute -top-24 -left-24 w-64 h-64 bg-[#eefcf4] rounded-full blur-3xl opacity-60 pointer-events-none">
            </div>
            ...
            <div class="flex-1 text-center md:text-left z-10">
                ...
                <div
                    class="inline-flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-xl text-sm font-medium text-gray-500 border border-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-50 relative overflow-hidden group">
                <div
                    class="absolute -right-10 -bottom-10 w-40 h-40 bg-gradient-to-tl from-[#eefcf4] to-transparent rounded-full blur-2xl opacity-50 group-hover:opacity-100 transition duration-500">
                </div>
                ...
                <div class="flex items-baseline gap-2">
                    <span
                        class="text-5xl lg:text-6xl font-black text-[#1cb764] tracking-tighter">{{ number_format($stats['contribution_items'], 0, ',', '.') }}</span>
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-50 relative overflow-hidden group">
                <div
                    class="absolute -right-10 -bottom-10 w-40 h-40 bg-gradient-to-tl from-[#fdf6ec] to-transparent rounded-full blur-2xl opacity-50 group-hover:opacity-100 transition duration-500">
                </div>
                <div class="w-12 h-12 bg-[#fdf6ec] rounded-2xl flex items-center justify-center text-[#f7b055] mb-6">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M17.5 3C13.5 3 10.5 5 8.5 8c-2 3-2.5 6-1.5 8H6c-2.2 0-4 1.8-4 4s1.8 4 4 4h4c2.2 0 4-1.8 4-4v-1.5c3-2 5-5 5-8C19 5.5 18 4 17.5 3zM12 20c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3-6.5c-2.5 0-4.5-2-4.5-4.5S12.5 4.5 15 4.5 19.5 6.5 19.5 9s-2 4.5-4.5 4.5z" />
                    </svg>
                </div>
                <p class="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Dampak Ekologis</p>
                <div class="flex items-baseline gap-2">
                    <span
                        class="text-5xl lg:text-6xl font-black text-[#f7b055] tracking-tighter">{{ number_format($stats['eco_impact_kg'], 1, ',', '.') }}</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-50">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('user.profile.edit', ['expand' => 'password', 'source' => 'profile']) }}"
                            ...
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition" fill="none"
                ...
                {{-- Bantuan --}}
                <div
                    class="bg-gradient-to-br from-[#f7b055] to-[#ed8b1a] rounded-[2rem] p-8 shadow-md relative overflow-hidden text-white">
                    ...
                    <p class="text-sm text-orange-50 font-medium leading-relaxed mb-8 relative z-10">Tim ShareBite siap
                        mendampingi perjalanan berbagi Anda 24/7</p>

                    <button
                        class="w-full bg-white text-[#e97d09] hover:bg-orange-50 font-extrabold px-6 py-4 rounded-full transition shadow-sm relative z-10">
