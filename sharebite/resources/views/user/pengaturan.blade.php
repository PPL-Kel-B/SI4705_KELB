...
<div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-50 min-h-[60vh] flex flex-col items-center justify-center text-center">
    ...
    <h2 class="text-2xl font-extrabold text-gray-800 mb-2">Pengaturan</h2>
    <p class="text-gray-500 max-w-md">Ini adalah halaman pengaturan. Nantinya preferensi sistem, notifikasi, dan keamanan akun Anda akan dikonfigurasi di sini.</p>
</div>
@endsection
