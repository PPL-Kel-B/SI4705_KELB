...
@section('title', 'Pendaftaran Unit Bisnis')
    ...
    <div class="hidden lg:flex lg:w-4/12 bg-[#1cb764] flex-col justify-between px-10 py-10 text-white relative overflow-hidden">
        ...
        <div class="z-10">
            <div class="bg-white rounded-full px-4 py-1.5 inline-flex items-center shadow-sm">
                <img src="{{ asset('images/logo.png') }}" alt="ShareBite Logo" class="h-6 object-contain" onerror="this.outerHTML='<span class=\'text-[#1cb764] font-bold text-lg\'>ShareBite</span>'">
            </div>
        </div>
        ...
        <div class="mt-8 z-10">
            ...
            <p class="text-sm text-white/80 leading-relaxed max-w-sm">
                Daftarkan unit bisnis Anda hari ini dan mulai optimalkan inventaris pangan berlebih Anda untuk membantu komunitas yang membutuhkan sekaligus mengurangi dampak lingkungan.
            </p>
        </div>
        ...
        <div class="mt-8 space-y-4 z-10 max-w-sm">
            <div class="bg-white/10 rounded-2xl p-4 flex items-center space-x-5 shadow-sm">
                ...
                <div>
                    ...
                    <div class="text-[11px] font-bold tracking-widest text-white uppercase mt-0.5">UNIT BISNIS TERDAFTAR</div>
                </div>
            </div>
            
            <div class="bg-white/10 rounded-2xl p-4 flex items-center space-x-5 shadow-sm">
                <div class="bg-white/20 p-3.5 rounded-2xl flex-shrink-0">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div>
                    ...
                    <div class="text-[11px] font-bold tracking-widest text-white uppercase mt-0.5">MAKANAN TERSELAMATKAN</div>
                </div>
            </div>
            ...
            <div class="bg-white/10 rounded-2xl p-4 flex items-center space-x-5 shadow-sm">
                ...
                <div>
                    ...
                    <div class="text-[11px] font-bold tracking-widest text-white uppercase mt-0.5">PENERIMA MANFAAT</div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-10 flex items-start space-x-2 text-xs text-white/80 z-10 font-medium">
            <svg class="w-4 h-4 shrink-0 text-[#f7b055]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
    ...
    <div class="w-full lg:w-8/12 flex justify-center py-8 px-6 sm:px-12 overflow-y-auto">
        <div class="w-full max-w-2xl">
            ...
            <div class="flex space-x-2 bg-[#EBF0EE] p-1.5 rounded-xl mb-8 text-sm font-medium text-center shadow-inner">
                <div class="w-1/3 bg-[#1cb764] text-white py-2.5 rounded-lg shadow-sm cursor-default">Unit Bisnis</div>
                <div class="w-1/3 text-gray-500 py-2.5 cursor-not-allowed">Komunitas</div>
                <div class="w-1/3 text-gray-500 py-2.5 cursor-not-allowed">Relawan</div>
            </div>
            ...
            <form action="{{ route('unit-bisnis.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="registForm">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" id="Nama_Usaha" name="Nama_Usaha" value="{{ old('Nama_Usaha') }}" placeholder="Contoh: Resto Lestari" class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#1cb764] outline-none transition" required>
                            <p id="err-nama" class="text-xs text-red-500 mt-1 hidden">Nama usaha tidak boleh kosong.</p>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Jenis Usaha</label>
                            <div class="relative">
                                <select name="Jenis_Usaha" class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3.5 text-sm text-gray-700 focus:ring-2 focus:ring-[#1cb764] outline-none appearance-none transition" required>
                                    <option value="Restoran" {{ old('Jenis_Usaha') == 'Restoran' ? 'selected' : '' }}>Restoran</option>
                                    <option value="Kafe" {{ old('Jenis_Usaha') == 'Kafe' ? 'selected' : '' }}>Kafe</option>
                                    <option value="Hotel" {{ old('Jenis_Usaha') == 'Hotel' ? 'selected' : '' }}>Hotel</option>
                    ...
                    <div class="mt-5">
                        ...
                        <textarea id="Alamat" name="Alamat" rows="2" placeholder="Jl. Keberlanjutan No. 88, Jakarta Selatan..." class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#1cb764] outline-none transition" required>{{ old('Alamat') }}</textarea>
                    ...
                    <div class="mt-5">
                        ...
                        <!-- Dropzone Area -->
                        <div id="upload-zone" class="border-2 border-dashed border-[#1cb764]/40 bg-[#1cb764]/5 rounded-2xl p-6 text-center transition hover:bg-[#1cb764]/10">
                            <svg class="w-8 h-8 mx-auto text-[#1cb764] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                            ...
                            <label class="inline-flex items-center px-5 py-2.5 bg-white border border-gray-300 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer shadow-sm transition">
                                ...
                                Unggah NIB
                                <input type="file" id="NIB_File" name="NIB_File" class="hidden" accept=".pdf,.jpg,.jpeg" required>
                            </label>
                        </div>
                        <p id="err-nib" class="text-xs text-red-500 mt-1 hidden">Harap unggah dokumen NIB.</p>

                        <!-- Success Uploaded State -->
                        <div id="upload-success" class="hidden bg-green-50 border border-green-200 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p id="file-name-display" class="text-sm font-bold text-gray-800 truncate max-wxs">dokumen.pdf</p>
                                    <p class="text-xs text-[#1cb764] font-medium">Berhasil diunggah</p>
                                </div>
                            </div>
                            <button type="button" id="remove-file" class="text-sm font-bold text-red-500 hover:text-red-700 px-3 py-1.5 rounded-lg hover:bg-red-50 transition">Ganti</button>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" id="Nomor_hp" name="Nomor_hp" value="{{ old('Nomor_hp') }}" placeholder="0812-XXXX-XXXX" class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#1cb764] outline-none transition" required>
                        ...
                        <div>
                            ...
                            <input type="email" id="Email" name="Email" value="{{ old('Email') }}" placeholder="admin@usaha.com" class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#1cb764] outline-none transition" required>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="relative">
                            <input type="password" id="Password" name="Password" placeholder="••••••••" maxlength="8" class="w-full bg-[#EBF0EE] border-none rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#1cb764] outline-none transition" required>
                            <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-500 hover:text-[#1cb764] transition">
                        ...
                        <div class="mt-2 bg-gray-50 p-3 rounded-lg border border-gray-100">
                            <ul class="text-xs space-y-1">
                                <li id="req-cap" class="flex items-center text-red-500 transition-colors">
                                    <svg class="w-3 h-3 mr-1.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                                ...
                                <li id="req-len" class="flex items-center text-green-500 transition-colors">
                                    <svg class="w-3 h-3 mr-1.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    Maksimal 8 karakter
                                </li>
                            </ul>
                        </div>
                ...
                <div>
                    ...
                    <div class="relative w-full h-56 bg-[#EBF0EE] rounded-2xl flex flex-col items-center justify-center mb-3 overflow-hidden border border-gray-200 group">
                        
                        <!-- The Map Container -->
                        <div id="map" class="absolute inset-0 z-0"></div>
                        
                        <!-- Overlay when map is not set yet -->
                        <div id="map-overlay" class="absolute inset-0 bg-[#d8ddd3]/50 flex flex-col items-center justify-center z-10 transition-opacity">
                            <button type="button" id="btn-lokasi" class="flex items-center bg-white px-5 py-2.5 rounded-full shadow-md text-sm font-bold text-gray-800 hover:bg-gray-50 hover:scale-105 transition transform">
                    ...
                    <div class="flex items-start text-xs text-gray-500">
                        <svg class="w-4 h-4 mr-1.5 shrink-0 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <p>Pastikan titik lokasi sesuai dengan alamat operasional bisnis Anda untuk penjemputan. Anda dapat menggeser pin lokasi (marker) jika titik kurang tepat.</p>
                    </div>
                    <p id="err-lokasi" class="text-xs text-red-500 mt-1 hidden">Lokasi harus ditentukan dari peta.</p>
                </div>

                <!-- Terms & Submit -->
                <div class="mt-8 space-y-6">
                    <label class="flex items-start space-x-3 bg-gray-50 p-4 rounded-xl border border-gray-200 cursor-pointer hover:bg-gray-100 transition">
                        <input type="checkbox" id="terms" required class="mt-1 w-5 h-5 text-[#1cb764] rounded border-gray-300 focus:ring-[#1cb764]">
                        <span class="text-sm text-gray-600 leading-relaxed select-none">
                            Saya bersedia mengikuti regulasi dan peraturan yang ada serta berkomitmen pada standar keamanan pangan <span class="font-bold text-[#1cb764]">ShareBite</span> secara konsisten.
                        </span>
                    </label>

                    <!-- Submit Button -->
                    <button type="submit" id="submitBtn" disabled class="w-full bg-[#1cb764] text-white font-bold py-4 rounded-xl shadow-lg transition duration-300 opacity-50 cursor-not-allowed">
                        Daftar Sekarang
                    </button>
                </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-500 font-medium">
                        Sudah memiliki akun mitra? <a href="#" class="text-[#1cb764] font-bold hover:underline">Masuk ke Dashboard</a>
                    </p>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function checkFormValidity() {
            // Check if terms checked
            const isTermsChecked = termsCheckbox.checked;
            
            // Ensure location is selected
            const isLocationSelected = latInput.value !== "" && lngInput.value !== "";

            // Check if file is uploaded
            const isFileUploaded = fileInput.files.length > 0;

            if(isTermsChecked && isLocationSelected && isFileUploaded && isPasswordValid) {
