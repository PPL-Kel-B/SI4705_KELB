...
<div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-50 min-h-[60vh] flex flex-col items-center justify-center text-center">
    ...
    <h2 class="text-2xl font-extrabold text-gray-800 mb-2">Riwayat Pesanan</h2>
    <p class="text-gray-500 max-w-md">Ini adalah halaman Riwayat. Seluruh histori transaksi yang telah selesai akan tercatat di sini.</p>
</div>
@endsection
