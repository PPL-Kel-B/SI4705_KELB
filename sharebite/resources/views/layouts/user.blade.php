        ...
        <header class="h-20 flex items-center justify-between px-6 lg:px-10">
            ...
            <div class="flex items-center gap-4">
                ...
                @if (!isset($hideSearch) || !$hideSearch)
                    <div class="flex gap-4">
                        ...
                        <button
                            class="hidden md:flex items-center gap-2 bg-white px-4 py-3 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 shadow-sm border border-gray-100">
            ...
            <div class="flex items-center gap-6">
                ...
                <button class="relative text-gray-500 hover:text-gray-700">
                    ...
                    <span
                        class="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-[#F4F7F5]"></span>
                </button>
