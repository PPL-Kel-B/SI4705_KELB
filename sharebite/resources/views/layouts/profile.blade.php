            ...
            <div class="lg:col-span-5 space-y-6">
                    ...
                    <div class="flex items-center gap-6">
                       {{-- Profile Photo Container --}}
                        ...
                        <div class="space-y-1.5">
                            <h2 class="text-2xl font-extrabold text-[#0a2e1f] tracking-tight leading-tight">
                                {{ $unitBisnis->nama_bisnis }}
                            </h2>
                            @if($unitBisnis->verified)
                            <div class="inline-flex items-center gap-1.5 bg-[#eefcf4] text-[#16a34a] px-3 py-1 rounded-lg text-[9px] font-extrabold tracking-wider leading-none uppercase">
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button type="button" @click="document.getElementsByName('nama_bisnis')[0].focus()" 
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text"
                                name="nama_bisnis"
                                value="{{ old('nama_bisnis', $unitBisnis->nama_bisnis) }}"
                                class="w-full text-base font-bold text-[#0a2e1f] bg-transparent border-b border-gray-100 border-x-0 border-t-0 rounded-none px-0 pb-2 focus:border-[#1cb764] focus:ring-0 transition-all placeholder-gray-300"
                        ...
                        <div class="space-y-1 relative">
                            ...
                            <div class="relative">
                                <select name="tipe_bisnis"
                                    class="w-full text-base font-bold bg-transparent border-b border-gray-100 border-x-0 border-t-0 rounded-none px-0 pb-2 pr-8 focus:border-[#1cb764] focus:ring-0 transition-all cursor-pointer appearance-none
                                    {{ empty(old('tipe_bisnis', $unitBisnis->tipe_bisnis)) ? 'text-gray-300' : 'text-[#0a2e1f]' }}">

                                    <option value="" disabled selected hidden>
                                        Masukkan tipe bisnis
                                    </option>

                                    <option value="Restoran" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Restoran' ? 'selected' : '' }}>
                                        Restoran
                                    </option>

                                    <option value="Kafe" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Kafe' ? 'selected' : '' }}>
                                        Kafe
                                    </option>

                                    <option value="Bakery" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Bakery' ? 'selected' : '' }}>
                                        Bakery
                                    </option>

                                    <option value="Catering" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Catering' ? 'selected' : '' }}>
                                        Catering
                                    </option>

                                    <option value="Hotel" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Hotel' ? 'selected' : '' }}>
                                        Hotel
                                    </option>

                                    <option value="Toko Makanan" {{ old('tipe_bisnis', $unitBisnis->tipe_bisnis) === 'Toko Makanan' ? 'selected' : '' }}>
                                        Toko Makanan
                                    </option>
                                </select>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="email" name="email_bisnis" value="{{ old('email_bisnis', $unitBisnis->email_bisnis) }}"
                                class="w-full text-base font-bold text-[#0a2e1f] bg-transparent border-b border-gray-100 border-x-0 border-t-0 rounded-none px-0 pb-2 focus:border-[#1cb764] focus:ring-0 transition-all placeholder-gray-300"
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="no_telepon" value="{{ old('no_telepon', $unitBisnis->no_telepon) }}"
                                id="no_telepon_input"
                                class="w-full text-base font-bold text-[#0a2e1f] bg-transparent border-b border-gray-100 border-x-0 border-t-0 rounded-none px-0 pb-2 focus:border-[#1cb764] focus:ring-0 transition-all placeholder-gray-300"
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button type="button" @click="document.getElementById('change-password-modal').showModal()"
                            class="flex items-center gap-1.5 text-xs font-semibold text-[#1cb764] hover:text-[#16a34a] transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                            </svg>
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.03)] space-y-6">
                    ...
                    <div class="bg-[#f7faf8] rounded-2xl p-5 border border-gray-50 flex items-start gap-4">
                        ...
                        <p id="alamat_display" class="text-sm font-bold text-[#0a2e1f] leading-relaxed text-left">
        ...
        <form method="POST" action="{{ route('unit.pengaturan.update-password') }}" class="modal-box max-w-sm rounded-3xl p-8 border border-gray-100 bg-white shadow-2xl">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="password" name="current_password" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-[#1cb764] focus:ring-2 focus:ring-green-100 outline-none transition-all"
                ...
                <div>
                    ...
                    <input type="password" name="password" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-[#1cb764] focus:ring-2 focus:ring-green-100 outline-none transition-all"
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-[#1cb764] focus:ring-2 focus:ring-green-100 outline-none transition-all"
        ...
        <div class="modal-box max-w-2xl rounded-3xl p-8 border border-gray-100 bg-white shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea id="modal_alamat" rows="3" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-[#1cb764] focus:ring-2 focus:ring-green-100 outline-none transition-all leading-relaxed"
                              placeholder="Contoh: Jl. Sukapura, Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung">{{ $unitBisnis->alamat }}</textarea>
                    <p class="text-xs text-gray-400 font-medium leading-relaxed mt-1.5">
                        *Ketika Anda mengetik atau mengubah alamat, peta akan otomatis berpindah ke lokasi yang sesuai.
                    </p>
                </div>

                <p class="text-xs text-gray-400 font-medium leading-relaxed">
                    *Klik titik lokasi pada peta atau geser pin. Sistem akan mengambil alamat paling detail yang tersedia dari OpenStreetMap, seperti nama jalan/gang/nomor rumah jika datanya tersedia.
                </p>
    ...
    @if ($errors->any())
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (el && el.__x) {
                    el.__x.$data.showError = true;
                    el.__x.$data.errorMessage = "Terdapat kesalahan pada data yang dimasukkan. Silakan periksa kembali.";
...
<script>
    ...
    const businessName = "{{ $unitBisnis->nama_bisnis ?? 'Bisnis' }}";
    ...
    function geocodeAddress(address) {
        ...
        // Bias search to Indonesia and prefer Indonesian language responses for better results
        const url = `https://nominatim.openstreetmap.org/search?format=json&limit=1&countrycodes=id&accept-language=id&q=${encodedAddress}`;
    ...
    // Reverse geocode coordinates to detailed address using Nominatim
        ...
        fetch(url)
            ...
            .then(data => {
                if (data && data.address) {
                    ...
                    if (gang && gang !== jalan && gang !== desa) {
                        parts.push(gang);
                    }

                    if (blok && blok !== gang && blok !== desa && blok !== kecamatan) {
                        parts.push(blok);
                    }
                    ...
                    if (kecamatan && kecamatan !== desa && kecamatan !== kota) {
                    ...
                    // Jika data detail jalan/gang/nomor rumah tidak tersedia di OpenStreetMap,
                    // gunakan display_name agar tetap tampil alamat paling lengkap dari peta.
    ...
    // Handle Edit Location Map Modal
    function openEditLocationModal() {
        document.getElementById('edit-location-modal').showModal();
        
        if (!editMap) {
            setTimeout(() => {
                editMap = L.map('edit-map').setView([
                    parseFloat(document.getElementById('lokasi_lat').value) || initLat,
                    parseFloat(document.getElementById('lokasi_lng').value) || initLng
                ], 18);
                ...
                // Add event listener for address input - geocode when user types/pastes/blur
                ...
                alamatInput.addEventListener('input', function() {
                    scheduleGeocode(this.value);
                });

                // Handle paste (IMEs or copy-paste) and blur to ensure geocoding triggers
                alamatInput.addEventListener('paste', function() {
                    setTimeout(() => scheduleGeocode(this.value), 200);
                });
    ...
    function saveLocationFromModal() {
        ...
        document.getElementById('alamat_display').innerText = alamat || 'Belum ada alamat';
