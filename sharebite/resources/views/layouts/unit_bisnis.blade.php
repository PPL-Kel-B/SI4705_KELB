    ...
    <aside
        ...
        <nav class="flex-1 overflow-y-auto px-4 space-y-2">
            ...
            <a href="{{ route('unit.chat') }}"
                class="flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('unit.chat') ? 'bg-[#eefcf4] text-[#0a2e1f] font-bold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 font-semibold' }}">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 shrink-0 {{ request()->routeIs('unit.chat') ? 'text-[#1cb764]' : '' }}" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
