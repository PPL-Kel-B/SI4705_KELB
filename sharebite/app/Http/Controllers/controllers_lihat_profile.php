...
<div class="flex min-h-screen">
  ...
  <aside class="w-64 bg-white shadow-md p-6">
    ...
    <nav class="space-y-4">
      <a class="block text-gray-600">Dashboard</a>
      <a class="block text-gray-600">Riwayat</a>
      <a class="block bg-green-100 text-green-700 px-3 py-2 rounded-lg">Profile</a>
      <a class="block text-gray-600">Pengaturan</a>
    </nav>
    <div class="mt-20 text-red-500">Logout</div>
  </aside>

  <!-- Content -->
  <main class="flex-1 p-10">
    <h2 class="text-2xl font-bold text-green-700 mb-6">Profile Saya</h2>

    <!-- Profile Card -->
    <div class="bg-white rounded-2xl shadow p-6 flex items-center justify-between">
      <div class="flex items-center gap-6">
        <div class="w-20 h-20 bg-green-100 rounded-2xl"></div>
        <div>
          <h3 class="text-xl font-bold">Alya</h3>
          <p class="text-sm text-gray-500">Terdaftar Jan 2023</p>
        </div>
      </div>
      <button class="bg-green-500 text-white px-4 py-2 rounded-full">Edit Profile</button>
    </div>

    <!-- Stats -->
    <div class="grid grid-cols-2 gap-6 mt-6">
      <div class="bg-green-50 p-6 rounded-2xl shadow">
        <p class="text-gray-500">Kontribusi Berbagi</p>
        <h3 class="text-3xl font-bold text-green-600">128</h3>
        <span class="text-sm">Item</span>
      </div>
      <div class="bg-green-100 p-6 rounded-2xl shadow">
        <p class="text-gray-500">Dampak Ekologis</p>
    ...
    <div class="grid grid-cols-3 gap-6 mt-6">
      ...
      <div class="col-span-2 bg-white p-6 rounded-2xl shadow">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input value="Alya" class="w-full mt-1 p-2 border rounded-lg" />
          </div>
          <div>
            <label class="text-sm text-gray-500">Alamat Email</label>
            <input value="alya@email.com" class="w-full mt-1 p-2 border rounded-lg" />
          </div>
          <div class="col-span-2">
            <label class="text-sm text-gray-500">Nomor Telepon</label>
            <input value="+62 812-3456-7890" class="w-full mt-1 p-2 border rounded-lg" />
          </div>
        </div>
      </div>
      ...
      <div class="bg-white p-6 rounded-2xl shadow">
        ...
        <ul class="space-y-3">
          <li class="flex justify-between text-gray-600">Ubah Kata Sandi <span>></span></li>
          <li class="flex justify-between text-gray-600">Notifikasi <span>></span></li>
        </ul>
      </div>
    ...
    <div class="grid grid-cols-3 gap-6 mt-6">
      ...
      <div class="bg-gradient-to-br from-green-400 to-green-600 text-white p-6 rounded-2xl shadow">
        ...
        <button class="bg-white text-green-600 px-4 py-2 rounded-full">Hubungi CS</button>
      </div>
    </div>
